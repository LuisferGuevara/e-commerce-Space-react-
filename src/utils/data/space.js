  ...
  galaxies: [
    {
      ...
      title: "Wan to visit Alpha Centauri?",
      description:
        "Alpha Centauri is a star system, and is widely believed to be the closest to the solar system at a distance of 4.37 light years. The star system is constituted of three stars, which include Alpha Centauri A, Alpha Centauri B, and Alpha Centauri C, which is often referred to as Proxima Centauri.",
      distance: "Distance: 2 year",
      price: "$2mn",
    },
    {
      name: "Andromeda",
      image:
        "https://besthqwallpapers.com/Uploads/25-11-2017/30404/thumb2-planet-universe-satellite-sci-fi-galaxy.jpg",
      title: "Want to visit Andromeda?",
      description:
        "The galaxy named after the greek godess a woman who can avhieve all, This trip will enhance women power if visited & the visitor will posess a greek godess power",
      distance: "Distance: 10 years",
      price: "$2Mn",
    },
    {
      name: "Needle Galaxy",
      image: "https://i.pinimg.com/originals/e4/d1/46/e4d1467af5b8467333f8658338b25651.jpg",
      title: "Want to visit the Needle Galaxy",
      description:
        "It lies close to the North Galactic Pole and has a visual magnitude of approximately 10. It is known as the Needle Galaxy for its narrow profile. It has more than $1Trillion stars",
      distance: "Distance: 10 years sleeping",
      price: "$2Mn",
    },
    {
      name: "Cannis Major",
      image: "https://cdn.pixabay.com/photo/2019/06/08/05/36/space-4259572_960_720.jpg",
      title: "Want to visit Cannis Major",
      description:
      ...
      distance: "Distance: 15 years sleeping",
      price: "$2Mn",
    },
    {
      name: "Black Hole",
      image: "https://cdn.mos.cms.futurecdn.net/4Vv43ekp8QVwL95So7Z8sb.jpg",
      title: "Want to sen your worst enemy to the Black Hole?",
      description:
        "This is the whole where you will never comeback we offer a service so you can send your enemies here as a surprise",
